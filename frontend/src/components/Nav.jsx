      ...
      <div className="flex items-center gap-4">
        ...
        {userData.role == "owner" ? (
          <>
            ...
            <div className="hidden md:flex items-center gap-2 px-3 py-1 cursor-pointer rounded-lg bg-[#ff4d2d]/10 text-[#ff4d2d] font-medium relative">
              <LuReceipt size={20} />
              <span>My Orders</span>
            ...
            <div className="md:hidden flex items-center gap-2 px-3 py-1 cursor-pointer rounded-lg bg-[#ff4d2d]/10 text-[#ff4d2d] font-medium relative">
              <LuReceipt size={20} />
              <span className="absolute -right-2 -top-2 text-xs font-bold text-white bg-[#ff4d2d] rounded-full px-[6px] py-[1px]">
                0
              </span>
